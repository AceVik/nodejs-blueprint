...
export function route<TParams = never>(handler: RouteHandler<TParams>): Route<TParams>;
export function route<TParams>(options: RouteOptions<TParams>, handler: RouteHandler<TParams>): Route<TParams>;
export function route<TParams>(
